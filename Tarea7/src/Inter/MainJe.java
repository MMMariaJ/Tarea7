...
public class MainJe {
    ...
    private void createGUI() {
        frame = new JFrame("Constructores por Año");
        ...
        progressBar.setForeground(new Color(173, 216, 230)); // Celeste
        ...
        table.setGridColor(new Color(173, 216, 230)); // Celeste para las líneas de la tabla
        ...
        table.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
                ...
                if (isSelected) {
                    c.setBackground(new Color(173, 216, 230)); // Celeste para la celda seleccionada
                } else {
                    if (row % 2 == 0) {
                        c.setBackground(new Color(173, 216, 230)); // Celeste para filas pares
                    } else {
                        c.setBackground(Color.WHITE); // Blanco para filas impares
                    }
                }
                return c;
            }
            ...
            SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
                ...
                protected Void doInBackground() throws Exception {
                    try {
                        ...
                        columnNames.add("Nombre de Contructor");
                        columnNames.add("Total de Puntos Ganados");
